    ...
    public class Combat
    {
        ...
        public static Composite CreateCombatRogueNormalCombat()
        {
            return new PrioritySelector(
                ...
                // WotLK: Killing Spree - use when low on energy and AR is down
                ...
                // WotLK Combat rotation - no Revealing Strike
        ...
        public static Composite CreateCombatRoguePvPCombat()
        {
            return new PrioritySelector(
                ...
                // WotLK: Killing Spree - use when low on energy
                Spell.Cast("Killing Spree",
                    ret => StyxWoW.Me.CurrentEnergy < 30 && !StyxWoW.Me.HasAura("Adrenaline Rush")),
        ...
        public static Composite CreateCombatRogueInstanceCombat()
        {
            return new PrioritySelector(
                ...
                // WotLK: Killing Spree - use when low on energy (Deep Insight doesn't exist in WotLK)
                Spell.Cast("Killing Spree", 
                    ret => StyxWoW.Me.CurrentEnergy < 30 && !StyxWoW.Me.HasAura("Adrenaline Rush")),
